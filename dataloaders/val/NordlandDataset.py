...
DATASET_ROOT = '/home/vpr/wcy/datasets/Nordland/'
GT_ROOT = '/home/vpr/wcy/s2vpr/CricaVPR_gai/dataloaders/datasets/' # BECAREFUL, this is the ground truth that comes with GSV-Cities
...
class NordlandDataset(Dataset):
    ...
    def __repr__(self):
        return  (f"< {self.__class__.__name__}, {'nordland'} - #database: {self.num_references}; #queries: {self.num_queries} >")
    


if __name__ == '__main__':
    a = np.load(GT_ROOT + 'Nordland/Nordland_dbImages.npy')
    print(a)