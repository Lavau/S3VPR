...
DATASET_ROOT = '/home/vpr/wcy/datasets/SPEDTEST/'
GT_ROOT = 'dataloaders/datasets/' # BECAREFUL, this is the ground truth that comes with GSV-Cities
...
class SPEDDataset(Dataset):
    ...
    def __repr__(self):
        return  (f"< {self.__class__.__name__}, {'SPED'} - #database: {self.num_references}; #queries: {self.num_queries} >")